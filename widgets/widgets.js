...
module.exports = {
    ...
    textnav: {
        ...
        event: {
            onLoad:function(widget_data, index){
                if (widget_data.show_type === 'scroll') {
                    var _this = this;
                    var idx = widget_data.activeIndex;
                    var arrlen = widget_data.items.length -1;
                    setInterval(function(){
                        ...
                        if(idx < arrlen) {
                          ...
                          form['widgets.textnav.' + index + '.activeIndex'] = idx;
                           _this.setData(form);
                    },Number(widget_data.timer))
                }
            }
        }
    },
    ...
    omnipotentform: {
        ...
        event: {
            onLoad: function(widget_data, index) {
                ...
                util.wxRequest({
                    ...
                    success: function(res) {
                        ...
                        form['widgets.omnipotentform.' + index + '.imgcode'] = 'https://'+wx.getExtConfigSync().host_pre+'app.vmcyun.com/vcode-index-universalform.html?sess_id=' + wx.getStorageSync('_SID');
                        _this.setData(form);
                ...
                wx.chooseImage({
                    ...
                    success: function(res) {
                        ...
                        var images = _this.data.widgets.omnipotentform[index].images ? _this.data.widgets.omnipotentform[index].images : [],
                          submitimages = _this.data.widgets.omnipotentform[index].submitdata&& _this.data.widgets.omnipotentform[index].submitdata[k] ? _this.data.widgets.omnipotentform[index].submitdata[k] : [];
            ...
            evt_getimagecode: function(e) {
                ...
                var img_url = 'https://'+wx.getExtConfigSync().host_pre+'app.vmcyun.com/vcode-index-universalform.html?' + new Date().getTime() + '&sess_id=' + wx.getStorageSync('_SID');
                this.setData({
                    [skey]: img_url,
                })
            }
